...
ATTACK_EVENTS = [
    {
        ...
        "message": "Admin user logged in successfully from Lagos, NG using trusted device fingerprint.",
    ...
    },
    {
        ...
        "message": "Same admin account logged in from Frankfurt, DE three minutes after Lagos login.",
    ...
    },
    {
        ...
        "message": "MFA push approved from unfamiliar ASN after two denied prompts.",
    ...
    },
    {
        ...
        "message": "Admin account granted itself super_admin role from the suspicious session.",
    ...
    },
    {
        ...
        "message": "Sensitive patient export endpoint returned 200 with 42 MB response body.",
        "event_type": "sensitive_export",
    ...
    },
    {
        ...
        "message": "EDR observed scripted download tooling on an admin workstation session.",
